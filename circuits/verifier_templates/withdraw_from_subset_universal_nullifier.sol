...
contract WithdrawFromSubsetUniversalNullifier {
    using ProofLib for ProofLib.G1Point;
    using ProofLib for ProofLib.G2Point;

    function withdrawFromSubsetUniversalNullifierVerifyingKey()
        internal
        pure
...
// VERIFYING_KEY
    ...
    function _verifyWithdrawFromSubsetUniversalNullifierProof(
